...
void PlatFormInfosImpl::SetFixPipeDtypeMap(const std::map<std::string, std::vector<std::string>>& fixpipe_dtype_map)
{
    fixpipe_dtype_map_ = fixpipe_dtype_map;
}

std::map<std::string, std::vector<std::string>> PlatFormInfosImpl::GetFixPipeDtypeMap() { return fixpipe_dtype_map_; }
...
void OptionalInfosImpl::SetFixPipeDtypeMap(const std::map<std::string, std::vector<std::string>>& fixpipe_dtype_map)
{
    fixpipe_dtype_map_ = fixpipe_dtype_map;
}

std::map<std::string, std::vector<std::string>> OptionalInfosImpl::GetFixPipeDtypeMap() { return fixpipe_dtype_map_; }
