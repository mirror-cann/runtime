...
public:
    ...
    static rtError_t AllocFromMemPool(
        void** ptr, uint64_t size, rtMemPool_t memPool, int32_t streamId, ReuseFlag& flag);
    ...
    static rtError_t AlignAndValidatePoolSize(
        rtMemPoolProps& poolProps, size_t totalSize, size_t alignSize = DEVICE_POOL_ALIGN_SIZE);
