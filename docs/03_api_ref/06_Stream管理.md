...
- [`aclError aclrtGetStreamAvailableNum(uint32_t *streamCount)`](#aclrtGetStreamAvailableNum（废弃）)：获取当前Device上剩余可用的Stream数量。（废弃接口）
...
<a id="aclrtGetStreamAvailableNum（废弃）"></a>
