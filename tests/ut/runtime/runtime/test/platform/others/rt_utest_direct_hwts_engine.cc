...
protected:
    static void SetUpTestCase() { std::cout << "RtOtherDirectHwtsEngine test start" << std::endl; }

    static void TearDownTestCase() { std::cout << "RtOtherDirectHwtsEngine test end" << std::endl; }
...
TEST_F(RtOtherDirectHwtsEngineTest, Start_failed)
{
    ...
    MOCKER_CPP(&DirectHwtsEngine::CreateRecycleThread).stubs().will(returnValue(RT_ERROR_MEMORY_ALLOCATION));
...
TEST_F(RtOtherDirectHwtsEngineTest, TryRecycleTask_test)
{
    ...
    MOCKER_CPP(&DirectHwtsEngine::TaskReclaimEx).stubs();
...
TEST_F(RtOtherDirectHwtsEngineTest, SendingWait_test)
{
    ...
    MOCKER_CPP_VIRTUAL(engine, &DirectHwtsEngine::TaskReclaim).stubs().will(returnValue(RT_ERROR_NONE));
