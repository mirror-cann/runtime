...
protected:
    void SetUp() { platform_infos = new PlatFormInfos(); }
...
protected:
    void SetUp() { optional_infos = new OptionalInfos(); }
...
TEST_F(OptionalInfosDefUTest, Init_Success) { EXPECT_TRUE(optional_infos->Init()); }
