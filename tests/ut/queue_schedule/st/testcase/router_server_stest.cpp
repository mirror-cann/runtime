...
protected:
    ...
    static void SetUpTestCase() { std::cout << "RouterServerStest SetUpTestCase" << std::endl; }

    static void TearDownTestCase() { std::cout << "RouterServerStest TearDownTestCase" << std::endl; }
};
