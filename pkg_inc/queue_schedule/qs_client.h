...
public:
    ...
    uint32_t BindQueueAlignment(
        const std::vector<BQSBindQueueAlignmentItem>& bindQueueVec,
        std::vector<BQSBindQueueResult>& bindResultVec) const;

    uint32_t UnbindQueueAlignment(
        const std::vector<BQSUnbindQueueAlignmentItem>& bindQueueVec,
        std::vector<BQSBindQueueResult>& bindResultVec) const;
